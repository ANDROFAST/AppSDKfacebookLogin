...
public class MainActivity extends AppCompatActivity {
    ...
    /**
     * Comprueba si el usuario ha iniciado sesión en Facebook y el token de acceso está activo
     * @return
     */
    ...
    /**
     * datos de interés el gestor de devolución de llamada
     * @param requestCode
     * @param resultCode
     * @param data
     */
